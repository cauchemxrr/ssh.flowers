...
function syncDataOnLoad() {
    ...
    const savedBouquets = localStorage.getItem('sshFlowersBouquets');
    const savedOrders = localStorage.getItem('sshFlowersOrders');
    ...
    if (!savedOrders) {
        // Если заказов нет, создаем пустой массив
        saveOrdersToStorage();
    }
...
function showCategoryBouquets(category) {
    ...
    // Принудительно загружаем данные перед показом
    loadBouquetsFromStorage();
...
function viewOrders() {
    ...
    // Принудительно загружаем заказы перед показом
    loadOrdersFromStorage();
...
function saveBouquetsToStorage() {
    try {
        ...
        console.log('Букеты сохранены в localStorage:', bouquetsDatabase);
    } catch (e) {
...
function loadBouquetsFromStorage() {
    try {
        ...
        if (saved) {
            ...
            console.log('Букеты загружены из localStorage:', bouquetsDatabase);
        } else {
            console.log('В localStorage нет данных о букетах, создаю пустую структуру');
            bouquetsDatabase = {
...
function saveOrdersToStorage() {
    try {
        ...
        console.log('Заказы сохранены в localStorage:', ordersDatabase);
    } catch (e) {
...
function loadOrdersFromStorage() {
    try {
        ...
        if (saved) {
            ...
            console.log('Заказы загружены из localStorage:', ordersDatabase);
        } else {
            console.log('В localStorage нет данных о заказах, создаю пустой массив');
            ordersDatabase = [];
            saveOrdersToStorage();
        }
    } catch (e) {
